...
class TestRiesgoMortal(unittest.TestCase):
    ...
    def test_con_riesgo_1_LV(self):
        tablero = [
            ['P', 'P', 'P', 'P', 'P', 'P', 'P', 'P', 'P', 'P', 'P', 'E', 'P', 'P', 'P', 'P'],
            ['P', '-', 'P', '-', '-', '-', '-', '-', '-', 'P', '-', '-', '-', '-', 'P', 'P'],
            ['P', '-', '-', '-', '-', 'P', 'P', '-', '-', '-', '-', 'P', '-', '-', '-', 'P'],
            ['P', '-', 'P', '-', 'P', '-', '-', 'P', 'P', '-', '-', 'P', '-', '-', 'P', 'P'],
            ['P', 'P', '-', 'P', '-', '-', 'LH', '-', 'P', 'P', 'P', '-', '-', 'LH', '-', 'P'],
    ...
    def test_con_riesgo_5_CD(self):
        tablero = [
            ['P', 'P', 'P', 'P', 'P', 'P', 'S', 'P', 'P', 'P', 'P', 'P', 'P', 'P', 'P', 'P'],
            ['P', 'P', '-', '-', '-', 'P', '-', '-', 'P', '-', '-', 'P', 'P', 'P', 'P', 'P'],
            ['P', 'P', 'P', 'P', 'P', '-', '-', '-', 'P', '-', 'P', '-', 'P', '-', 'P', 'P'],
            ['P', '-', '-', '-', '-', 'P', '-', '-', 'P', '-', '-', '-', 'P', '-', 'P', 'P'],
            ['P', '-', '-', 'P', 'P', '-', '-', 'P', '-', '-', '-', '-', '-', '-', 'LV', 'P'],
