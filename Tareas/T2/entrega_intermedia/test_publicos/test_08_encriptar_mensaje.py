...
class TestEncriptarMensaje(unittest.TestCase):
    ...
    def test_2(self):
        ...
        self.assertIsInstance(respuesta, bytearray)
        opciones_validas = [
            bytearray(b'0\xc3 e,i eAnu vnu\xb1ovodava'),
            bytearray(b'\x00\xc3 e,i eAnu vnu\xb1ovodava'),
        ]
        self.assertIn(respuesta, opciones_validas)
    ...
    def test_3(self):
        ...
        opciones_validas = [
            ...
            bytearray(
                b"\x01\xc3e\xc3d\xc3t\xc3\xb1h\xb1\xc3\xb4\xc3\xb4\xc2a\xc3i\xc3r"
                b"\xc3ch\xb1l\xc2\xb4\xc3\xb1\xc3\xb1\xb1\xb1\xb1\xb1\xb1\xb1"
                b"\xb1\xc3\xc3\xc3\xb1\xc2\xb1\xc2\xb4"
            ),
        ]
    ...
    def test_4(self):
        ...
        opciones_validas = [
            ...
            bytearray(
                b"\x01{[]`\xc2\xbf?\xb8\xc2\xc2\xa8?\xc2|\xc2#$)=~"
                b"\xc2[]\xc2\xb4\xa8*~\'\xa1\\*^\'\xc2\\\xc2\xc2"
                b"\xac&/@\xc2\xc2\xac}+\xc2^\xa8\xc2\xc2\xc2\xa8`~"
                b"\xbf\xa1\xb8\xb0!%(|\xb7\xbd{}"
            ),
    ...
    def test_5(self):
        ...
        opciones_validas = [
            ...
            bytearray(
                b'\x01\xe2\xa0\xc6\xe2\x80\x92\xc5\xa1\xe2\xe2\x82\xc5\xa0\x80\x80\x92\xac\xb0\xc5\xbd'
            ),
        ]
        self.assertIn(respuesta, opciones_validas)
