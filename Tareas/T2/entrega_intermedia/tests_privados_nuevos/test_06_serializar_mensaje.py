...
class TestSerializarMensaje(unittest.TestCase):
    ...
    def test_0(self):
        ...
        self.assertEqual(respuesta, b"Hola Mumdo")

    def test_1(self):
        mensaje = "Hola Mendo\n"
        respuesta = serializar_mensaje(mensaje)
        self.assertIsInstance(respuesta, bytearray)
        self.assertEqual(respuesta, b"Hola Mendo\n")

    def test_2(self):
        mensaje = "Holaa Mundo\nHola Mundo\nHola Mundo\n"
        respuesta = serializar_mensaje(mensaje)
        self.assertIsInstance(respuesta, bytearray)
        self.assertEqual(respuesta, b"Holaa Mundo\nHola Mundo\nHola Mundo\n")
    ...
    def test_4(self):
        mensaje = "Año nuevo, vida nuevas"
        respuesta = serializar_mensaje(mensaje)
        self.assertIsInstance(respuesta, bytearray)
        self.assertEqual(respuesta, b"A\xc3\xb1o nuevo, vida nuevas")
    ...
    def test_6(self):
        mensaje = "ñoñeñiñdñrñtñchñhñlññ´´ññ´´ñ"
        respuesta = serializar_mensaje(mensaje)
        self.assertIsInstance(respuesta, bytearray)
        self.assertEqual(respuesta,
                         b"\xc3\xb1o\xc3\xb1e\xc3\xb1i\xc3\xb1d\xc3\xb1r\xc3\xb1t\xc3"
