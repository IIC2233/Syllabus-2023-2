...
class TestPeliculaGeneroMayorRating(unittest.TestCase):
    ...
    def test_0(self):
        ...
        lista_peliculas = [
            ...
            Peliculas(id=95413069, titulo="The Cheetah Girls 2", genero="Comedia", rating=6.1),
            ...
            Peliculas(id=99972342, titulo="The Cheetah Girls", genero="Comedia", rating=5.9),
        ]
    ...
    def test_1(self):
        ...
        lista_peliculas = [
            ...
            Peliculas(id=96374386, titulo="The Lord of the Rings: The Two Towers", genero="Crimen", rating=8.7),
            ...
            Peliculas(id=75901837, titulo="Akira", genero="Crimen", rating=8.6),
            ...
            Peliculas(id=64787434, titulo="Casino", genero="Crimen", rating=9.0),
            Peliculas(id=73020923, titulo="Captain America: The First Avenger", genero="Animación", rating=7.0),
        ]

        resultado = pelicula_genero_mayor_rating(lista_peliculas, "Crimen")

        self.assertIsInstance(resultado, str)
        self.assertEqual(resultado, "Seven Samurai")
    ...
    def test_2(self):
        ...
        lista_peliculas = [
            ...
            Peliculas(id=27868789, titulo="Guardians of the Galaxy", genero="Animación", rating=7.5),
            Peliculas(id=59848286, titulo="The Silence of the Lambs", genero="Suspense", rating=8.6),
            Peliculas(id=19177277, titulo="High School Musical 3", genero="Deportes", rating=6.9),
            Peliculas(id=73079370, titulo="Thor: The Dark World", genero="Animación", rating=7.2),
        ...
        resultado = pelicula_genero_mayor_rating(lista_peliculas, "Musical")

        self.assertIsInstance(resultado, str)
        self.assertEqual(resultado, "High School Musical 2")
    ...
    def test_3(self):
        ...
        self.assertIsInstance(resultado, str)
        self.assertEqual(resultado, "The Prestige")
