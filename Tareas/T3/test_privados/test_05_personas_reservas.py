...
class TestPersonasReservas(unittest.TestCase):
    ...
    def test_0(self):
        ...
        """
        lista_reservas = [
            Reservas(id_persona=245756, id_funcion=4718, numero_butaca="C10"),
        ...
        expected_set_funciones = {245756, 278561, 138975, 673894, 621438, 739182, 463289, 364298,
                                  954362, 149872, 984723, 735242, 245769, 376581, 951827, 946353,
                                  824156, 419725}

        resultado = personas_reservas(iter(lista_reservas))
        self.assertIsInstance(resultado, (list, tuple, set, filter, map, Generator))
        self.assertCountEqual(list(resultado), expected_set_funciones)
    ...
    def test_1(self):
        ...
        expected_set_funciones = {954362, 186243, 745219, 654365, 317984, 278561,
    ...
    def test_2(self):
        ...
        """
        lista_reservas = [
            Reservas(id_persona=454543, id_funcion=9721, numero_butaca="H6"),
            Reservas(id_persona=454543, id_funcion=4718, numero_butaca="C7"),
            Reservas(id_persona=454543, id_funcion=9721, numero_butaca="A7"),
            Reservas(id_persona=454543, id_funcion=7617, numero_butaca="B1"),
            Reservas(id_persona=454543, id_funcion=9721, numero_butaca="E3"),
            Reservas(id_persona=454543, id_funcion=9391, numero_butaca="B3"),
            Reservas(id_persona=454543, id_funcion=9391, numero_butaca="G7"),
            Reservas(id_persona=454543, id_funcion=4293, numero_butaca="D3"),
            Reservas(id_persona=454543, id_funcion=9391, numero_butaca="D5"),
            Reservas(id_persona=454543, id_funcion=4718, numero_butaca="C5"),
            Reservas(id_persona=454543, id_funcion=9721, numero_butaca="F8"),
            Reservas(id_persona=454543, id_funcion=9721, numero_butaca="E4"),
            Reservas(id_persona=454543, id_funcion=7617, numero_butaca="F2"),
            Reservas(id_persona=454543, id_funcion=7617, numero_butaca="B10"),
            Reservas(id_persona=454543, id_funcion=9721, numero_butaca="D1"),
            Reservas(id_persona=454543, id_funcion=9721, numero_butaca="C9"),
            Reservas(id_persona=454543, id_funcion=4718, numero_butaca="B2"),
            Reservas(id_persona=454543, id_funcion=4293, numero_butaca="A4"),
            Reservas(id_persona=454543, id_funcion=7617, numero_butaca="A1"),
            Reservas(id_persona=454543, id_funcion=7617, numero_butaca="E9"),
        ]

        expected_set_funciones = {454543}
    ...
    def test_4(self):
        ...
        expected_set_funciones = {654546, 781245, 745219, 278561, 765476, 962734, 745219, 781245,
                                  895642, 596318, 745219, 917346, 367591, 312497, 138975, 765653,
                                  691734, 518367, 917346, 248765}
