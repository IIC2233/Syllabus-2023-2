...
class TestGeneroMasTransmitido(unittest.TestCase):
    ...
    def test_0(self):
        ...
        lista_funciones = [
            Funciones(id=4971, numero_sala=7, id_pelicula=38937194, horario=7, fecha="25-08-23"),
            Funciones(id=1709, numero_sala=1, id_pelicula=95417284, horario=9, fecha="18-11-23"),
            Funciones(id=5507, numero_sala=6, id_pelicula=38937194, horario=1, fecha="24-06-23"),
            Funciones(id=4899, numero_sala=5, id_pelicula=32152163, horario=4, fecha="28-08-23"),
            Funciones(id=1677, numero_sala=7, id_pelicula=54541808, horario=6, fecha="24-06-23"),
            Funciones(id=2630, numero_sala=9, id_pelicula=19177277, horario=5, fecha="16-12-23"),
            Funciones(id=2789, numero_sala=3, id_pelicula=35569845, horario=6, fecha="24-06-23"),
            Funciones(id=7821, numero_sala=2, id_pelicula=85032662, horario=9, fecha="23-02-23"),
            Funciones(id=2358, numero_sala=4, id_pelicula=93369344, horario=2, fecha="24-06-23"),
            Funciones(id=3967, numero_sala=5, id_pelicula=95417284, horario=4, fecha="21-04-23"),
            Funciones(id=4743, numero_sala=8, id_pelicula=45064961, horario=7, fecha="01-07-23"),
            Funciones(id=2227, numero_sala=5, id_pelicula=45064961, horario=3, fecha="24-06-23"),
            Funciones(id=7196, numero_sala=8, id_pelicula=47191880, horario=5, fecha="24-06-23"),
            Funciones(id=2514, numero_sala=6, id_pelicula=91153956, horario=9, fecha="07-11-23"),
            Funciones(id=6432, numero_sala=5, id_pelicula=19177277, horario=9, fecha="24-06-23"),
            Funciones(id=5941, numero_sala=9, id_pelicula=35569845, horario=4, fecha="15-10-23"),
            Funciones(id=3598, numero_sala=4, id_pelicula=11615401, horario=4, fecha="01-10-23"),
            Funciones(id=6028, numero_sala=5, id_pelicula=58643843, horario=1, fecha="18-11-23"),
            Funciones(id=4164, numero_sala=2, id_pelicula=85032662, horario=8, fecha="19-10-23"),
            Funciones(id=8900, numero_sala=6, id_pelicula=34321575, horario=7, fecha="24-06-23"),
            Funciones(id=9901, numero_sala=8, id_pelicula=93369344, horario=4, fecha="27-01-23"),
            Funciones(id=8498, numero_sala=3, id_pelicula=95230455, horario=3, fecha="24-06-23"),
            Funciones(id=6376, numero_sala=8, id_pelicula=19177277, horario=3, fecha="24-06-23"),
            Funciones(id=9281, numero_sala=1, id_pelicula=47191880, horario=3, fecha="14-09-23"),
            Funciones(id=8019, numero_sala=1, id_pelicula=70752273, horario=9, fecha="24-06-23"),
            Funciones(id=1311, numero_sala=3, id_pelicula=42038936, horario=2, fecha="17-04-23"),
            Funciones(id=1688, numero_sala=3, id_pelicula=47191880, horario=9, fecha="15-05-23"),
            Funciones(id=3443, numero_sala=6, id_pelicula=87114047, horario=8, fecha="24-06-23"),
            Funciones(id=8434, numero_sala=3, id_pelicula=42475848, horario=9, fecha="18-03-23"),
    ...
    def test_2(self):
        ...
        lista_funciones = [
            ...
            Funciones(id=8651, numero_sala=3, id_pelicula=32152163, horario=9, fecha="28-12-23"),
            Funciones(id=3915, numero_sala=8, id_pelicula=32608840, horario=3, fecha="27-10-23"),
            Funciones(id=6281, numero_sala=9, id_pelicula=55774654, horario=5, fecha="05-02-23"),
            Funciones(id=9054, numero_sala=5, id_pelicula=76172796, horario=4, fecha="14-06-23"),
            Funciones(id=1435, numero_sala=1, id_pelicula=30060914, horario=8, fecha="27-03-23"),
            Funciones(id=5776, numero_sala=4, id_pelicula=73079370, horario=4, fecha="06-01-23"),
            Funciones(id=6019, numero_sala=9, id_pelicula=76172796, horario=9, fecha="20-04-23"),
            ...
            Funciones(id=9324, numero_sala=8, id_pelicula=32608840, horario=2, fecha="17-06-23"),
            Funciones(id=3560, numero_sala=8, id_pelicula=89708109, horario=1, fecha="10-04-23"),
            Funciones(id=6494, numero_sala=5, id_pelicula=75421892, horario=7, fecha="10-04-23"),
            Funciones(id=3489, numero_sala=9, id_pelicula=55774654, horario=1, fecha="26-04-23"),
            Funciones(id=5704, numero_sala=8, id_pelicula=83829256, horario=7, fecha="21-05-23"),
            Funciones(id=6797, numero_sala=3, id_pelicula=20610700, horario=2, fecha="09-12-23"),
            ...
            Funciones(id=7540, numero_sala=2, id_pelicula=62764502, horario=2, fecha="27-07-23"),
            Funciones(id=2782, numero_sala=8, id_pelicula=41068976, horario=8, fecha="24-03-23"),
            Funciones(id=3568, numero_sala=1, id_pelicula=75203860, horario=3, fecha="23-12-23"),
            ...
            Funciones(id=9609, numero_sala=8, id_pelicula=62764502, horario=7, fecha="05-04-23"),
    ...
    def test_3(self):
        ...
        lista_funciones = [
            Funciones(id=6947, numero_sala=2, id_pelicula=89587896, horario=1, fecha="26-11-23"),
            Funciones(id=2704, numero_sala=6, id_pelicula=89587896, horario=8, fecha="01-04-23"),
            Funciones(id=3971, numero_sala=3, id_pelicula=42986062, horario=3, fecha="09-04-23"),
            Funciones(id=9431, numero_sala=8, id_pelicula=89587896, horario=7, fecha="01-04-23"),
            Funciones(id=1798, numero_sala=1, id_pelicula=78376301, horario=9, fecha="10-11-23"),
            Funciones(id=6969, numero_sala=4, id_pelicula=89587896, horario=1, fecha="01-04-23"),
            Funciones(id=8099, numero_sala=1, id_pelicula=89587896, horario=9, fecha="11-07-23"),
            Funciones(id=2801, numero_sala=6, id_pelicula=89587896, horario=6, fecha="01-04-23"),
            ...
            Funciones(id=5454, numero_sala=1, id_pelicula=58643843, horario=9, fecha="11-10-23"),
            Funciones(id=9501, numero_sala=6, id_pelicula=67027889, horario=6, fecha="09-12-23"),
            Funciones(id=9714, numero_sala=6, id_pelicula=89587896, horario=3, fecha="01-04-23"),
            Funciones(id=3827, numero_sala=1, id_pelicula=79145064, horario=9, fecha="26-10-23"),
            Funciones(id=5486, numero_sala=7, id_pelicula=79145064, horario=2, fecha="01-04-23"),
            Funciones(id=4213, numero_sala=2, id_pelicula=75660450, horario=7, fecha="20-10-23"),
            Funciones(id=9846, numero_sala=3, id_pelicula=99972342, horario=9, fecha="01-04-23"),
            ...
            Funciones(id=2742, numero_sala=9, id_pelicula=11568343, horario=3, fecha="23-11-23"),
            ...
            Funciones(id=6406, numero_sala=6, id_pelicula=90803337, horario=8, fecha="19-11-23"),
            Funciones(id=8148, numero_sala=3, id_pelicula=99972342, horario=8, fecha="01-04-23"),
            Funciones(id=6899, numero_sala=5, id_pelicula=92004621, horario=2, fecha="05-06-23"),
